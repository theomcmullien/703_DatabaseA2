...
using Assignment2.Models.General;
...
namespace Assignment2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(256, ErrorMessage = "Firstname field has a maximum of 256 characters")]
            [Display(Name = "Firstname")]
            public string Firstname { get; set; }

            [Required]
            [StringLength(256, ErrorMessage = "Lastname field has a maximum of 256 characters")]
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Roles.Add(Constants.Roles.Housekeeper);
            Roles.Add(Constants.Roles.Reception);
            Roles.Add(Constants.Roles.Manager);
            Roles.Add(Constants.Roles.Customer);
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.TravelAgencyID = Input.TravelAgencyID;
